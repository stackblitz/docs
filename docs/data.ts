...
export const dotNewLinks = [
  { title: 'Analog.js', link: 'https://analogjs.org/new', icon: '' },
  { title: 'Astro', link: 'https://astro.new/', icon: '' },
  { title: 'Cloudflare Workers', link: 'https://workers.new/typescript', icon: '' },
  { title: 'Docusaurus', link: 'https://docusaurus.new/', icon: '' },
  { title: 'Eleventy', link: 'https://11ty.new/' /* or https://eleventy.new */, icon: '' },
  { title: 'Faker', link: 'https://fakerjs.dev/new', icon: '' },
  { title: 'Hydrogen', link: 'https://hydrogen.new/', icon: '' },
  { title: 'Ladle', link: 'https://ladle.dev/new', icon: '' },
  { title: 'NativeScript (TS)', link: 'https://nativescript.new/', icon: '' },
  { title: 'NativeScript (JS)', link: 'https://nativescript.new/javascript', icon: '' },
  { title: 'NativeScript Angular', link: 'https://nativescript.new/angular', icon: '' },
  { title: 'NativeScript React', link: 'https://nativescript.new/react', icon: '' },
  { title: 'NativeScript Svelte', link: 'https://nativescript.new/svelte', icon: '' },
  { title: 'NativeScript Vue', link: 'https://nativescript.new/vue', icon: '' },
  { title: 'Next.js', link: 'https://nextjs.new/', icon: '' },
  { title: 'Node.js', link: 'https://node.new/', icon: '' },
  { title: 'Nodemon', link: 'https://node.new/nodemon', icon: '' },
  { title: 'Nx', link: 'https://node.new/nx', icon: '' },
  { title: 'Qwik', link: 'http://qwik.new/', icon: '' },
  { title: 'Rakkas', link: 'https://rakkasjs.org/new', icon: '' },
  { title: 'Remix', link: 'https://remix.new/', icon: '' },
  { title: 'Slidev', link: 'https://sli.dev/new', icon: '' },
  { title: 'SolidJS', link: 'https://solid.new/', icon: '' },
  { title: 'Storybook', link: 'https://storybook.new/', icon: '' },
  { title: 'SvelteKit', link: 'https://sveltekit.new', icon: '' },
  { title: 'Vite', link: 'https://vite.new/', icon: '' },
  { title: 'VitePress', link: 'https://vitepress.new/', icon: '' },
  { title: 'Vitest', link: 'https://vitest.new/', icon: '' },
];
