...
This can be useful when a project doesn’t define a custom `startCommand`, or if you want to share a link than runs a different script then the one specified in `startCommand`.
