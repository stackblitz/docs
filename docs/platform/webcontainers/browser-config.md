...
Note that this may not be very practical, because the exact domain for a project can change between sessions, especially in [Stackblitz Editor](/guides/user-guide/working-in-codeflow-ide).
